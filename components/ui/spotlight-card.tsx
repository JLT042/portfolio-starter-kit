...
const glowColorMap = {
  ...
  green:  { base: 135, spread: 60  }, // tuned for brand oklch(75% 0.165 140)
...
const glowCSS = `
  ...
  [data-glow]::before {
    background-image: radial-gradient(
      ...
      hsl(var(--hue, 210) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 50) * 1%) / var(--border-spot-opacity, 0.7)),
      transparent 100%
    );
    filter: brightness(2);
  }
...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  height,
  customSize = false,
  backdropColor = 'oklch(15% 0.012 260)',
  ...rest
}) => {
